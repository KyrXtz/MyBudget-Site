<template>
  <div id="app" :class="{ 'text-dark': !nightMode, 'text-light': nightMode }">
    ...
    <div class="parent">
      ...
      <AppSteps id="appSteps" :nightMode="nightMode" />
      <Features id="features" :nightMode="nightMode" />
      <EndingNotes id="endingNotes" :nightMode="nightMode" />
      <GetGooglePlay id="getGooglePlay" :nightMode="nightMode" />
...
import EndingNotes from "./components/EndingNotes";
import GetGooglePlay from "./components/GetGooglePlay";
...
export default {
  ...
  mounted() {
    ["appSteps", "getGooglePlay", "features", "endingNotes"].forEach((l) => {
